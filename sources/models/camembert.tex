...
\renewcommand{\roberta}{RoBERTa\xspace}
\renewcommand{\bert}{BERT\xspace}
\renewcommand{\mbert}{mBERT\xspace}
...
\renewcommand{\ccnet}{CCNet\xspace}
...
Pretrained language models benefits from being trained on large datasets \cite{devlin2018mbert,liu2019roberta,raffel2019exploring}. %can be significantly improved by using more data
...
%We also experiment training a BASE model longer for 500k steps, \camembertccnetlong, as advised in \cite{liu2019roberta}. 
