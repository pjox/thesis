...
%SOTA
\include{sources/sota/oscar}
\include{sources/sota/models}
\include{sources/sota/evaluation}

\part{OSCAR}
\include{sources/oscar/goclassy}
\include{sources/oscar/monolingual}
\include{sources/oscar/quality}
\include{sources/oscar/ungoliant}
\include{sources/oscar/towards}

\part{French Corpora}
\include{sources/french/contemporary}
\include{sources/french/historical}

\part{Models and Evaluation}
\include{sources/mod_eval/camembert}
\include{sources/mod_eval/frelmo}
\include{sources/mod_eval/cabernet}
\include{sources/mod_eval/sinner}
\include{sources/mod_eval/bertrade}
\include{sources/mod_eval/dalembert}

\appendix

\include{sources/appendix/oscar/goclassy}
\include{sources/appendix/oscar/monolingual}
\include{sources/appendix/oscar/quality}
\include{sources/appendix/oscar/towards}

\include{sources/appendix/mod_eval/camembert}
\include{sources/appendix/mod_eval/bertrade}
\include{sources/appendix/mod_eval/dalembert}
...
\include{sources/backmatter/license}
