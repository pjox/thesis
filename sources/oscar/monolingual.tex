...
Having released OSCAR 2019, the first thing that we wanted to do with it was to evaluate how good it actually was for what it was mainly intended, that is, the pre-training of contextualized word embeddings tha had just become available such as ULMFiT \citep{howard-ruder-2018-universal}, ELMo \citep{peters-etal-2018-deep} or BERT \citep{devlin-etal-2019-bert}
