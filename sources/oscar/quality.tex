...
\begin{table}[!htbp]
    ...
    \caption{Rater evaluation for a subset of audits from \textbf{CCAligned} (aligned with English) measured by the accuracy (Acc-$n$) of annotations by non-proficient speaker against annotations by proficient speakers.
