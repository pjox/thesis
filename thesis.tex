...
%SOTA
\include{sources/sota/goclassy}
\include{sources/sota/monolingual}
\include{sources/sota/quality}
\include{sources/sota/towards}
\include{sources/sota/camembert}
\include{sources/sota/ftb}
\include{sources/sota/sinner}
\include{sources/sota/bertrade}
\include{sources/sota/dalembert}

\part{OSCAR}
\include{sources/oscar/goclassy}
\include{sources/oscar/monolingual}
\include{sources/oscar/quality}
\include{sources/oscar/full_tables}
\include{sources/oscar/ungoliant}
\include{sources/oscar/towards}

\part{French Data}
\include{sources/french/cabernet}
...
\include{sources/appendix/goclassy}
